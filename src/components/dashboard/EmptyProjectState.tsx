      ...
      <div className="max-w-[600px] w-full text-center space-y-8">
        ...
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-2xl bg-white dark:bg-neutral-800 shadow-sm border border-neutral-200 dark:border-neutral-700 flex items-center justify-center">
            <FolderKanban className="text-teal-600 w-8 h-8" />
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-teal-600 dark:text-teal-400 text-lg md:text-xl font-medium mt-2">
        ...
        <div className="pt-2 flex flex-col items-center gap-3">
          <Button
            ...
            size="lg"
            className="inline-flex items-center justify-center px-8 py-6 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-teal-600/20 hover:shadow-teal-600/30 text-base"
          >
