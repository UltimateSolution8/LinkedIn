            ...
            <div className="mt-4 overflow-y-auto max-h-[70vh] space-y-4">
              ...
              {(mainPainpoint || matchReason) && (
                <div className="flex flex-col gap-2">
                  ...
                  {matchReason && (
                    <div className="flex items-start gap-2 bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800/40 rounded-md px-3 py-2">
                      <Target className="w-3.5 h-3.5 text-purple-500 mt-0.5 flex-shrink-0" />
                      <div className="flex flex-col gap-0.5">
                        <span className="text-xs font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-wide">How It Fits</span>
                        <span className="text-xs text-purple-800 dark:text-purple-300">{matchReason}</span>
                      </div>
                    </div>
                  )}
                </div>
