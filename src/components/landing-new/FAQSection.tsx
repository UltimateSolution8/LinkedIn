...
const faqData = {
  product: [
    {
      ...
      answer: "Rixly monitors keyword signals, problem statements, alternative comparisons, and recommendation requests inside discussions. These patterns indicate users who are actively evaluating solutions and not just browsing.",
    },
    {
    ...
    },
    {
      ...
      answer: "You'll see relevant conversations surfaced within minutes of setup. Qualified leads typically appear within 2 to 4 weeks depending on your niche, engagement quality, and follow up process.",
    },
    {
      question: "Is social media lead generation scalable?",
      answer: "Yes. With structured monitoring and AI assisted engagement, you can cover dozens of subreddits and hundreds of conversations without it becoming a full time job. Most users spend 15 to 20 minutes per day.",
    },
  ],
  platforms: [
    {
      question: "Is Reddit good for B2B lead generation?",
      answer: "Yes. B2B buyers openly discuss product challenges, compare alternatives, and ask for recommendations inside niche subreddits. Monitoring those conversations lets you engage at the moment of intent. No cold outreach or paid ads.",
    },
    {
  ...
  pricing: [
    {
      ...
      answer: "Scraping tools export raw data, usernames, post lists, and bulk exports. Rixly identifies real buyer intent inside conversations and helps you engage intelligently with AI suggested replies. The focus is on conversion ready discussions, not data dumps.",
    },
    {
  ...
  security: [
    ...
    },
    {
      ...
      answer: "Because the buyer starts the conversation. On Reddit, users are actively describing their problems and asking for solutions. You're responding to existing demand and not interrupting someone who didn't ask to hear from you.",
    },
    {
