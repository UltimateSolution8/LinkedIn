...
import { LayoutDashboard, Flame, Target, Settings, Plus, BookOpen, MessageSquare } from "lucide-react";
...
export default function AppSidebar({ leadsCount = 0, opportunitiesCount = 0 }: AppSidebarProps) {
  ...
  const handleFeedbackClick = async () => {
    try {
      ...
      console.warn("[AppSidebar] Failed to persist feedback-completed flag:", error);
    }
